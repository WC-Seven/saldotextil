        ...
        isLoading ? (
          ...
          <Container>
            ...
            <Button title="Publicar" onPress={() => {
              ...
              if (ads.images[0].uri === '' && route.params.name !== 'donations') {
                Alert.alert(
                  'Que tal uma imagem?',
                ...
                setIsLoading(true);
                announcement.update(section, folder, 'ads', ads, () => navigation.goBack(), () => setIsLoading(false), item.uid);
              }
            }} />
            <SpacedView />
          </Container>

          ...
          <>
              ...
              <View style={{ backgroundColor: 'rgba(0, 0, 0, 0.8)', flex: 1 }}>
                ...
                <View style={{ marginHorizontal: 30, minHeight: 200, backgroundColor: '#fff', padding: 15 }}>
                  ...
                  <View style={{ marginTop: 10 }}>
                    <Text style={{ fontFamily: 'Poppins Medium' }}>{ announcement.graduation }</Text>

                    <Text style={{ fontFamily: 'Poppins Regular', marginTop: 10 }}>{ `Setor - ${announcement.intendedSector}` }</Text>
                    <Text style={{ fontFamily: 'Poppins Regular' }}>{ `Cargo - ${announcement.intendedPosition}` }</Text>
                    <Text style={{ fontFamily: 'Poppins Regular' }}>{ `Salário - ${announcement.intendedSalary}` }</Text>
                  </View>
            ...
            <TouchableOpacity style={{ flexDirection: 'row' }} onPress={() => setIsModalVisible(true)}>
              ...
              <View style={{ marginLeft: 10, justifyContent: 'space-between' }}>
                ...
                <Text style={{ fontFamily: 'Poppins Regular' }}>{ announcement.intendedPosition }</Text>
              </View>
            </TouchableOpacity>
          </>
        )
